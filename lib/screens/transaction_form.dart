...
class _TransactionFormState extends State<TransactionForm> {
  ...
  void _showFailureMessage(
    ...
    showDialog(
      ...
      builder: (_) => NetworkGiffyDialog(
        image: Image.network('https://media2.giphy.com/media/mq5y2jHRCAqMo/giphy.gif?cid=790b7611f6167436237be5502a5bc7ac8ea2fa2999ff2f08&rid=giphy.gif&ct=g'),
        title: Text(
          'Ops!',
  ...
  void _showToast(String msg, {int duration = 5, int gravity}) {
    Toast.show(msg, context,
        duration: duration, gravity: gravity ?? Toast.BOTTOM);
  }
}
